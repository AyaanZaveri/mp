    ...
    const dataToSend = {
      ...
      indexFinger:
        results.landmarks.length == 2
          ? [results.landmarks[0][8], results.landmarks[1][8]]
          : [results.landmarks[0][8]],
      middleFinger:
        results.landmarks.length == 2
          ? [results.landmarks[0][12], results.landmarks[1][12]]
          : [results.landmarks[0][12]],
      thumb:
        results.landmarks.length == 2
          ? [results.landmarks[0][4], results.landmarks[1][4]]
          : [results.landmarks[0][4]],
      wrist:
        results.landmarks.length == 2
          ? [results.landmarks[0][0], results.landmarks[1][0]]
